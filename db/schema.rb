...
ActiveRecord::Schema.define(version: 2023_02_23_174858) do
  ...
  create_table "drinks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["glass_id"], name: "index_drinks_on_glass_id"
  end
...
ActiveRecord::Schema.define(version: 2023_02_25_220641) do
  ...
  create_table "drinks", id: :integer, default: nil, force: :cascade do |t|
    t.string "name"
    t.string "image"
    t.string "tags"
    t.bigint "glass_id"
  ...
  create_table "glasses", id: :integer, default: nil, force: :cascade do |t|
    t.string "name"
    t.string "image"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "ingredients", id: :integer, default: nil, force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.string "image"
    t.string "image_s"
